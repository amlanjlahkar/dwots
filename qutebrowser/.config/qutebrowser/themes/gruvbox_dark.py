...
# Padding for hint characters
c.hints.padding = {"bottom": 4, "left": 4, "right": 4, "top": 4}

# Background color for hints. Note that you can use a `rgba(...)` value
# for transparency.
c.colors.hints.bg = 'rgba(250,189,47,0.8)'
...
# Radius for the edges of the keyhint dialouge
c.keyhint.radius = 4
...
c.colors.tabs.odd.fg = base0G

# Background color of unselected odd tabs.
c.colors.tabs.odd.bg = base00

# Foreground color of unselected even tabs.
c.colors.tabs.even.fg = base0G
...
c.colors.tabs.selected.odd.bg = base0H

# Foreground color of selected even tabs.
c.colors.tabs.selected.even.fg = base06

# Background color of selected even tabs.
c.colors.tabs.selected.even.bg = base0H
